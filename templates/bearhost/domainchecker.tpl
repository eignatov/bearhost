...
<div class="well">
    ...
    <div align="right" class="multitldbtn margin2"><input type="button" value="{$LANG.searchmultipletlds} &raquo;" class="btn " onclick="jQuery('#tlds').slideToggle()" /></div>
    ...
    <div class="textcenter">
        ...
        <div class="margin1"><input type="submit" value="{$LANG.checkavailability}" class="btn btn-primary btn-large" />{if $condlinks.domaintrans} <input type="submit" name="transfer" value="{$LANG.domainstransfer}" class="btn btn-success btn-large" />{/if} <input type="submit" name="hosting" value="{$LANG.domaincheckerhostingonly}" class="readmore_but5 nofloat" /></div>
