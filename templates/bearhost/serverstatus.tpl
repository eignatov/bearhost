...
<a href="{$smarty.server.PHP_SELF}?view=open" class="networkissuesopen readmore_but5 nofloat">{$opencount} {$LANG.networkissuesstatusopen}</a> 

<a href="{$smarty.server.PHP_SELF}?view=scheduled" class="networkissuesopen readmore_but5 nofloat">{$scheduledcount} {$LANG.networkissuesstatusscheduled}</a>



<a href="{$smarty.server.PHP_SELF}?view=resolved" class="networkissuesopen readmore_but5 nofloat">{$resolvedcount} {$LANG.networkissuesstatusresolved}</a>
