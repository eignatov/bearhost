<div class="row">
    ...
    <div class="col40">
        <div class="internalpadding last">
...
<div class="styled_title1 margin2">
<a class="btn pull-right" href="submitticket.php"><i class="fa fa-comment"></i> {$LANG.opennewticket}</a>
    <h3>{$LANG.supportticketsopentickets} <span class="badge badge-info">{$clientsstats.numactivetickets}</span></h3>
</div>



<table class="table table-striped table-framed table-centered tbtop">
    <thead>
        <tr>
