...
{foreach from=$quotes item=quote}
        <tr>
            ...
            <td>{$quote.stage}</td>
            <td class="textcenter"><input type="button" class="readmore_but5 nofloat" value="{$LANG.quoteview}" onclick="window.location='viewquote.php?id={$quote.id}'" />&nbsp;&nbsp;&nbsp;<input type="button" class="readmore_but5 nofloat" value="{$LANG.quotedownload}" onclick="window.location='dl.php?type=q&id={$quote.id}'" /></td>
        </tr>
{foreachelse}
        <tr>
