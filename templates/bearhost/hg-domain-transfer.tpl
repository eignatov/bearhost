      ...
      <ul>
        ...
        <li data-transition="fade" data-slotamount="1" data-masterspeed="1500" data-thumb="templates/{$template}/html/images/sliders/slider1_thumb.jpg" data-delay="13000"  data-saveperformance="off"  data-title="Our Workplace"> 
          ...
          <div class="tp-caption sfb"
						...
						data-captionhidden="off"
						style="z-index: 6">
            <form method="post" id="domain-searchform" action="cart.php?a=add&domain=transfer">
              <div>
                <input class="input-text" name="sld" id="dsearch" onblur="if(this.value=='')this.value='Enter your domain name here...'" onfocus="if(this.value=='Enter your domain name here...')this.value=''" value="Enter your domain name here..." type="text" />
