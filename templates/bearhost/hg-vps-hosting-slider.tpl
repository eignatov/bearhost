<?php include_once('header.php');?>
  ...
  <div class="section_holder2 two">
    <div class="container">
      ...
      <div id="chooseplan" align="center">
        ...
        <div id="hostpslider" class="ui-slider ui-slider-horizontal ui-widget ui-widget-content ui-corner-all" aria-disabled="false"><div class="ui-slider-range ui-widget-header ui-corner-all ui-slider-range-min" style="width: 100%;"></div><a href="#" class="ui-slider-handle ui-state-default ui-corner-all" style="left: 100%;"></a></div>
        <div class="cleaner h10"></div>
        <div class="sb sml" align="left">
            <p><strong>Small</strong></p>
        </div>
        <div class="lb med" align="center">
            <p><strong>Medium</strong></p>
        </div>
        <div class="lb lar" align="center">
        ...
        <div class="container">
          <div class="one_third"> 
          <input type="text" disabled="disabled" id="BW" class="lt_title_big">
                  <div class="box"><label for="BW">Bandwidth:</label></div></div>
                  
                  <div class="one_third"> 
         <input type="text" disabled="disabled" id="DS" class="lt_title_big">
                  <div class="box">  <label for="DS">Disk Space:</label></div></div>
                  
                  <div class="one_third last"> 
           <input type="text" disabled="disabled" id="Price" class="lt_title_big">
                  <div class="box"><label for="Price">Price<sub>/MO</sub></label></div></div>
                
              
               
            </div>
            <div class="cleaner h10"></div>
            <div class="readmore_but2 cent" align="center">
                <a href="#">Order</a>
            </div>
        </div>
 ...
 <!--<div class="server">
            <div style="display: block;" id="s_4" class="ps_server"></div>
            <div id="s_3" class="ps_server" style="display: none;"></div>
            <div style="display: none;" id="s_2" class="ps_server"></div>
            <div style="display: none;" id="s_1" class="ps_server"></div>
        </div>-->
