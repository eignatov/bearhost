...
<div class="searchbox">
    ...
    <form method="post" action="clientarea.php?action=domains">
        ...
        <div class="input-append">
            ...
            <input type="text" name="q" value="{if $q}{$q}{else}{$LANG.searchenterdomain}{/if}" class="input-medium appendedInputButton" onfocus="if(this.value=='{$LANG.searchenterdomain}')this.value=''" /><button type="submit" class="readmore_but5 nofloat">{$LANG.searchfilter}</button>
...
{foreach key=num item=domain from=$domains}
        ...
        <tr>
            ...
            <td>
                ...
                <a class="btn" href="clientarea.php?action=domaindetails&id={$domain.id}"> <i class="fa fa-wrench"></i> {$LANG.managedomain}</a>
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a href="clientarea.php?action=domaindetails&id={$domain.id}#tab3"><i class="fa fa-globe"></i> {$LANG.domainmanagens}</a></li>

                    <li><a href="clientarea.php?action=domaincontacts&domainid={$domain.id}"><i class="fa fa-user"></i> {$LANG.domaincontactinfoedit}</a></li>

                    <li><a href="clientarea.php?action=domaindetails&id={$domain.id}#tab2"><i class="fa fa-globe"></i> {$LANG.domainautorenewstatus}</a></li>

                    <li class="divider"></li>

                    <li><a href="clientarea.php?action=domaindetails&id={$domain.id}"><i class="fa fa-pencil"></i> {$LANG.managedomain}</a></li>
...
<a class="btn btn-inverse" href="#" data-toggle="dropdown"><i class="fa fa-folder-open icon-white" style="margin-top: 5px;"></i> {$LANG.withselected}</a>

<a class="btn btn-inverse dropdown-toggle" href="#" data-toggle="dropdown"><span class="caret"></span></a>

<ul class="dropdown-menu">

    <li><a href="#" id="nameservers" class="setbulkaction"><i class="fa fa-globe"></i> {$LANG.domainmanagens}</a></li>

    <li><a href="#" id="autorenew" class="setbulkaction"><i class="fa fa-refresh"></i> {$LANG.domainautorenewstatus}</a></li>

    <li><a href="#" id="reglock" class="setbulkaction"><i class="fa fa-lock"></i> {$LANG.domainreglockstatus}</a></li>

    <li><a href="#" id="contactinfo" class="setbulkaction"><i class="fa fa-user"></i> {$LANG.domaincontactinfoedit}</a></li>

    {if $allowrenew}<li><a href="#" id="renew" class="setbulkaction"><i class="fa fa-repeat"></i> {$LANG.domainmassrenew}</a></li>{/if}
