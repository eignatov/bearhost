...
$_LANG['domainbulkregister'] = "Registro Masivo de Dominios";
...
$_LANG['domainsimplesearch'] = "Buscar Nombre de Dominios";
...
# Plantilla
$_LANG['support247'] = "24x7 Technical Support";
$_LANG['aboutUs'] = "Acerca de BearHost";
$_LANG['homesearchdomain'] = "<h1 class=\"lt_title_medium\">Buscar  <span>nombre de dominio</span></h1>";
$_LANG['homedomainfree'] = "Incluye cuentas de correo gratuito y proteccion de privacidad";
$_LANG['homeenterdomainname'] = "Ingresar nombre de dominio...";
$_LANG['homehostingplan'] = "<h1 class=\"lt_title_medium\">Planes de <span>Web Hosting</span></h1>";
$_LANG['homesloganhosting'] = "Asequible, Fiable y Seguro.";
$_LANG['homehostunlimited'] = "Dominios, cuentas de correo y espacio ilimitados";
$_LANG['homehostsupport'] = "Soporte tecnico 24/7 premiado";
$_LANG['homehostbackguarante'] = "Devolucion de dinero garantizado";
$_LANG['homehostbandwidth'] = "Ancho de banda Ilimitado";
$_LANG['homehostflexible'] = "Panel de control facil de usar y flexible";
$_LANG['homeviewallplans'] = "Ver Planes";
$_LANG['homewelcomebh'] = "<h1 class=\"lt_title_big\">Hosting <span>100% COLOMBIANO</span></h1>";

$_LANG['homescript'] = "Más de 300 scripts disponibles para la instalación instantánea con 1 solo click.";
$_LANG['homebuynow'] = "Comprar!";
$_LANG['homesince'] = "Desde";
$_LANG['homepricewh'] = "$2,99";
$_LANG['homepricevps'] = "$19,95";
$_LANG['homepriceds'] = "$79,99";
$_LANG['homemonth'] = "mes";
$_LANG['homewebhostingcap'] = "WEB HOSTING";
$_LANG['homevirtualprivateserver'] = "VPS hosting";
$_LANG['homededservers'] = "Servidores dedicados";
$_LANG['homewebhostingdescrip'] = "Ideal para sitios web personales, pequeñas empresas y blogs."; 
$_LANG['homevpsdescrip'] = "cuando un Webhosting se queda corto para tus necesidades y excediste los recursos de este.";
$_LANG['homedsdescrip'] = "si necesitas mayor rendimiento, mayor disponibilidad , mas recursos da el gran paso a un servidor de calidad.";
$_LANG['homeviewallplans'] = "Ver más planes";
$_LANG['homeyouneeda'] = "¿Necesitas un";
$_LANG['homeawebsite'] = "Sitio WEB ?";
$_LANG['hometextwelcome'] = "Ofrecemos el mejor servicio de <strong>WEBHOSTING</strong> en <strong>COLOMBIA</strong> y <strong>AMERICA LATINA</strong>, todos nuestros servidores e infraestructura están en Colombia, es por eso que nuestros precios son realmente <strong>competitivos</strong>, Además que podemos brindar la mejor <strong>calidad</strong> en nuestro servicio con IP´S Colombianas y contamos con un Profesionales altamente calificados.";
$_LANG['homefeatures'] = "Unico en Colombia";
$_LANG['hometextfeatures'] = "Ofrecemos el mejor servicio de <strong>WEBHOSTING</strong> en <strong>COLOMBIA</strong> y <strong>AMERICA LATINA</strong>, todos nuestros servidores e infraestructura están en Colombia, es por eso que nuestros precios son realmente <strong>competitivos</strong>, Además que podemos brindar la mejor <strong>calidad</strong> en nuestro servicio con IP´S Colombianas y contamos con Profesionales altamente calificados.";
$_LANG['homecheapwebsites'] = "Sitios Web Realmente economicos";
$_LANG['homepersonalwebsites'] = "Sitios Web Personales y Blogs";
$_LANG['homebusinesswebsites'] = "Sitios Web para Empresas y Negocios";
$_LANG['homeartistwebsite'] = "Sitios Web Para Artistas y Personajes Publicos";
$_LANG['homeecommercewebsites'] = "Tiendas Virtuales o Ecommerce ";
$_LANG['homeeasymigration'] = "nuestros especialistas realizan el proceso de migracion fácil y sin problemas, independiente de la plataforma de donde vengas ya sea hosting compartido o servidor dedicado. ";
$_LANG['homeisfree'] = "y es Gratuito.";
$_LANG['homeiseasy'] = "es muy Fácil.";
$_LANG['homeisfast'] = "es realmente Rápido.";
$_LANG['homecheaphosting'] = "Hosting Economico";
$_LANG['homewhatsinclude'] = "¿Que Incluye?";

$_LANG['homewehavedevelopers'] = "Tenemos los mejores desarrolladores web en colombia a su disposicion para crear sus proyectos";
$_LANG['homewecreatedesigns'] = "creamos diseños totalmente innovadores y adaptativos a cualquier dispositivo con los estandares actuales";
$_LANG['homecomingfrom'] = "Vienes de otro";
$_LANG['homeanotherhost'] = "Hosting?";
...
$_LANG['hostinghome'] = "Web Hosting Economico";
...
$_LANG['hostingallincludes'] = "Todos nuestros planes <span>Incluyen</span>";
$_LANG['hostingallincludetext'] = "Nuestros planes incluye las mejores carateristicas para ofrecer un servicio profesional, conoce nuestras caracteristicas incluidad.";
$_LANG['hosting'] = "";
$_LANG['hosting'] = "";
$_LANG['hosting'] = "";
$_LANG['hosting'] = "";
...
$_LANG['domaintextdotcom'] = "texto  de ejemplo";
$_LANG['domaintextdotnet'] = "texto  de ejemplo";
$_LANG['domaintextdotorg'] = "texto  de ejemplo";
$_LANG['domainpricedotcomdashed'] = "$9.99";
$_LANG['domainpricedotnetdashed'] = "$9.99";
$_LANG['domainpricedotorgdashed'] = "$9.99";
$_LANG['domainpricedotcom'] = "$92.99";
$_LANG['domainpricedotnet'] = "$92.99";
$_LANG['domainpricedotorg'] = "$92.99";
